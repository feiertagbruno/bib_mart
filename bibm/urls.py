...
urlpatterns = [
    ...
    path("meuslivros/<filtro>/<ordem>/", views.meus_livros, name="meus_livros"),
    path("editarplanejamento/<filtro>/<ordem>/", views.editar_planejamento, name="editar_planejamento"),
